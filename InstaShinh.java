...
class SocialMedia
{
   ...
   public void followBack(String first, String last)//This method goes through the arraylist and finds the person with the given first and last name then follows that person
   {
     String s = first + " " + last;
   ...
   public boolean follow(String first, String last, String username, boolean followBack)//This meathod adds the new follower to the list
    {
