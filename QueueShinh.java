...
class Driver
{
   public static void main(String[] args)
   {
      ...
      System.out.println("Product = " + m.getProduct()+"          (THIS IS MY METHOD, THIS CALCULATES THE PRODUCT OF THE ENTIRE QUEUE)");
...
class yourDriver
{
   public static void main(String[] args)
   {
      ...
      System.out.println("Product of all the numbers is " + m2.getProduct()+"          (THIS IS MY METHOD, THIS CALCULATES THE PRODUCT OF THE ENTIRE QUEUE)");
