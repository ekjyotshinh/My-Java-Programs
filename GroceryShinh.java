...
class Item implements Comparable<Object> {
   ...
   public boolean equals(Item other)// Meathod that checks if two are equal based on the basis of their food name
                                    // and price
   {
...
// Once you have completeed all the classes run your code with the given driver,
// then write your own driver
class Driver {
...
/*
 * implement your own driver and test all the methods. Your driver must be very
