...
class Expression {
   ...
   public String getPostfix() {
      ...
      while (st.hasMoreTokens()) {
         ...
         if (token.equals("*") || token.equals("/") || token.equals("+") || token.equals("-")) // If the token is any of
                                                                                               // the operations +, -,
                                                                                               // /, *
         {
            ...
            if (precedence == 3) // If the precedence is 3
            {
               ...
               while (!operand.isEmpty() && precedence(top) == 3) // while the stack is not empty and the precedence of
                                                                  // the top of the stack is 3//the token is * or /
               {
            ...
            {
               String top = (String) operand.peek();
               while (!operand.isEmpty() && (precedence(top) == 2 || precedence(top) == 3)) // while the stack is not
                                                                                            // empty and the precedence
   ...
   public int evalPostfix() {
      ...
      while (st.hasMoreTokens()) {
         String token = st.nextToken();
         if (token.equals("*") || token.equals("/") || token.equals("+") || token.equals("-")) // if the token is an
                                                                                               // operator then we
                                                                                               // calculate
         {
