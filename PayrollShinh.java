public class PayrollShinh { // list of the instnace variables
    ...
    public double getPay() // This meathod calculates the pay of an individual by multipluing the hours
                           // worked by the pay rate
    {
...
class PayrollDriver {
    public static void main(String[] args) {
        ...
        // changing the hoursworked for the objects created by calling the setter
        // methods
